...
export const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      <section>
<nav
  className="relative flex w-full items-center justify-between py-2 shadow-sm shadow-neutral-700/10 dark:bg-neutral-800 dark:shadow-black/30 lg:flex-wrap lg:justify-start"
  data-te-navbar-ref>
  ...
  <div className="flex w-full flex-wrap items-center justify-between px-6">
    ...
    <div className="!visible hidden flex-grow basis-[100%] items-center lg:!flex lg:basis-auto"
      ...
      <ul className="mr-auto lg:flex lg:flex-row" data-te-navbar-nav-ref>
        ...
        <li className="mb-2 lg:mb-0" data-te-nav-item-ref>
          <a className="block py-2 pr-2 text-neutral-500 transition duration-150 ease-in-out hover:text-neutral-600 focus:text-neutral-600 disabled:text-black/30 dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300 dark:disabled:text-white/30 lg:px-2 [&.active]:text-black/80 dark:[&.active]:text-white/80"
            href="#!" data-te-nav-link-ref data-te-ripple-init data-te-ripple-color="light">Nos valeurs</a>
        </li>
      </ul>
    ...
    <div className="my-1 flex items-center lg:my-0 lg:ml-auto">
      ...
      <button type="button"
        className="inline-block rounded bg-[#584523] px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal 
        text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out 
        hover:opacity-75 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] 
...
<div className="relative overflow-hidden bg-cover bg-no-repeat custom-hero-bg bg-[#458236]">
  <div
    ...
    <div className="flex h-full items-center justify-center">
      <div className="px-6 text-center text-white md:px-12">
        <h1 className={`${fontFamily} mt-2 mb-16 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl`}>
          Les plus belles tables de New York<br /><span className="text-[#485]">La perfection du goût</span>
        </h1>
        <button type="button"
          className="font-mono rounded border-2 border-neutral-50 px-[46px] pt-[14px] pb-[12px] text-sm font-medium uppercase leading-normal text-neutral-50 transition duration-150 ease-in-out hover:border-neutral-100 hover:bg-neutral-100 hover:bg-opacity-10 hover:text-neutral-100 focus:border-neutral-100 focus:text-neutral-100 focus:outline-none focus:ring-0 active:border-neutral-200 active:text-neutral-200"
          data-te-ripple-init data-te-ripple-color="light">
          Réserver une table
        </button>
      </div>
