        ...
        className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-[hsla(0,0%,0%,0.75)] bg-fixed">
         <div className="flex h-full items-center justify-center">
                <div className="px-6 text-center text-white md:px-12">
                    <h1 className={`${fontFamily} opacity-0 title mt-2 mb-16 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl`}>
                        Les plus belle tables {city}<br /><span className="text-[#485] square">La perfection du goût</span>
                    </h1>
                    <button type="button"
                        onClick={showGuestSection}
                        className="button opacity-0 font-mono rounded border-2 border-gray-50 px-[46px] pt-[14px] pb-[12px] 
