...
export const Header: React.FC = () => {
  ...
  return (
<nav
  className="header-minh relative flex w-full items-center justify-between py-2 shadow-sm shadow-neutral-700/10 dark:bg-neutral-800 dark:shadow-black/30 lg:flex-wrap lg:justify-start"
  data-te-navbar-ref>
